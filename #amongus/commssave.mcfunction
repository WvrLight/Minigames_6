execute if score CommunicationsDisabled disabledcomms matches 0..49 run scoreboard players add CommunicationsDisabled disabledcomms 1
execute if score CommunicationsDisabled disabledcomms matches 0..49 run playsound minecraft:weather.rain master @s ~ ~ ~ 0.2 2
execute if score CommunicationsDisabled disabledcomms matches 0..49 run playsound minecraft:weather.rain master @s ~ ~ ~ 0.2 0.7
execute if score CommunicationsDisabled disabledcomms matches 0..49 run playsound minecraft:weather.rain master @s ~ ~ ~ 0.2 1.5
execute if score CommunicationsDisabled disabledcomms matches 0..49 run scoreboard players set @s aufatigue 0

execute if score CommunicationsDisabled disabledcomms matches 0..49 if score CommsMira audummy matches 0..24 run scoreboard players add CommunicationsDisabled disabledcomms 1
execute if score CommunicationsDisabled disabledcomms matches 0..50 if score CommsMira audummy matches 0..24 run scoreboard players add CommsMira audummy 1
execute if score CommunicationsDisabled disabledcomms matches 0..49 if score CommsMira audummy matches 0..24 run playsound minecraft:weather.rain master @s ~ ~ ~ 0.2 2
execute if score CommunicationsDisabled disabledcomms matches 0..49 if score CommsMira audummy matches 0..24 run playsound minecraft:weather.rain master @s ~ ~ ~ 0.2 0.7
execute if score CommunicationsDisabled disabledcomms matches 0..49 if score CommsMira audummy matches 0..24 run playsound minecraft:weather.rain master @s ~ ~ ~ 0.2 1.5
execute if score CommunicationsDisabled disabledcomms matches 0..49 if score CommsMira audummy matches 0..24 run scoreboard players set @s aufatigue 0

execute if score CommsMira audummy matches 25 unless score CommsMira2 audummy matches 25 run tellraw @s {"text":"This radio has been fixed. Go to other radio in Office to fully fix communications.","color":"green"}
execute if score CommsMira audummy matches 25 run execute as @s at @s run playsound minecraft:entity.player.levelup master @s ~ ~ ~ 1 1.5
execute if score CommsMira audummy matches 25 run effect clear @e[tag=CommsMarkM] minecraft:glowing

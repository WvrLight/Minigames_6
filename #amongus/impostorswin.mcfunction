...
execute as @a[tag=crewmate] at @s run playsound minecraft:block.end_portal.spawn master @s ~ ~ ~ 0.3 1
execute as @a[tag=impostor] at @s run playsound minecraft:ui.toast.challenge_complete master @s ~ ~ ~ 0.5 1
...
title @a[tag=impostor] title ["",{"text":"Victory!","bold":true,"color":"green"}]
title @a[tag=crewmate] title ["",{"text":"Defeat.","color":"dark_red"}]
title @a[tag=amongusplayer] subtitle ["",{"text":"Impostors: ","color":"dark_red"},{"selector":"@a[tag=impostor]","color":"dark_red"}]

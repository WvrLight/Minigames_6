...
execute if score LockDoors ausabotage matches 0 run execute positioned 167 194 -227 run playsound minecraft:block.piston.extend master @a ~ ~ ~ 0.9 0

execute if score LockDoors ausabotage matches 0 run scoreboard players set lockele audummy 10

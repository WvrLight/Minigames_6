...
execute if score LockDoors ausabotage matches 0 run execute positioned 130 194 -245 run playsound minecraft:block.piston.extend master @a ~ ~ ~ 0.9 0
execute if score LockDoors ausabotage matches 0 run execute positioned 140 194 -233 run playsound minecraft:block.piston.extend master @a ~ ~ ~ 0.9 0

execute if score LockDoors ausabotage matches 0 run scoreboard players set lockengl audummy 10

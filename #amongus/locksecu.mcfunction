...
execute if score LockDoors ausabotage matches 0 run execute positioned 141 194 -258 run playsound minecraft:block.piston.extend master @a ~ ~ ~ 0.9 0

execute if score LockDoors ausabotage matches 0 run scoreboard players set locksecu audummy 10

...
spreadplayers 198 -283 1 5 false @a[tag=amongusplayer]
execute as @a[tag=amongusplayer] at @s run tp ~ ~-3 ~
...
give @a[tag=amongusplayer] minecraft:filled_map{display:{Name:'{"text":"The Skeld","color":"gray","bold":false,"italic":false}',MapColor:4538175},aumap:1,map:530} 1
...
scoreboard players set ReactorMeltdownMira ausabotage 10
scoreboard players set OxygenDepletionMira ausabotage 10
scoreboard players set BlackoutMira ausabotage 10
...
execute as @a[tag=amongusplayer] at @s run function datapack:amongus/assigntask
...
tag @a[tag=impostor] remove commsacpower

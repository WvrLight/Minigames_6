...
title @a subtitle ["",{"text":"Blocks","bold":true,"color":"dark_green"},{"text":" win!","bold":true,"color":"green"},{"text":" Congratulations, ","color":"green"},{"selector":"@a[tag=block]","bold":true,"color":"dark_green"}]

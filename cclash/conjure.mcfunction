...
execute if score @s cclashSpell matches 49 run scoreboard players set @s cclashCooldown 14
...
execute if score @s cclashSpell matches 59 run scoreboard players set @s cclashCooldown 12

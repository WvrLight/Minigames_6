...
tellraw @a [""]
tellraw @a ["",{"text":"[CLICK HERE] ","color":"aqua","clickEvent":{"action":"run_command","value":"/execute as @s at @s run function datapack:cclash/join"}},{"text":"to join the next game.","color":"yellow"}]
tellraw @s ["",{"text":"[CLICK HERE] ","color":"aqua","clickEvent":{"action":"run_command","value":"/execute as @s at @s run function datapack:cclash/start"}},{"text":"to start the game.","color":"yellow"}]
tellraw @a [""]

...
execute as @e[tag=cclashIspikesNew] at @s run function datapack:cclash/levelabove
execute as @e[tag=cclashIspikesNew] at @s run function datapack:cclash/levelbelow	

...
execute as @e[tag=cclashMeteorNew] at @s run function datapack:cclash/levelbelow
execute as @e[tag=cclashMeteorNew] at @s run function datapack:cclash/levelabove

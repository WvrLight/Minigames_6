...
scoreboard players set @e[tag=cclashSlightningNew] cclashDummy 75
execute as @e[tag=cclashSlightningNew] at @s run function datapack:cclash/levelabove
execute as @e[tag=cclashSlightningNew] at @s run function datapack:cclash/levelbelow	
...
scoreboard players set @e[tag=cclashSlightningNew] cclashDummy 70
execute as @e[tag=cclashSlightningNew] at @s run function datapack:cclash/levelabove
execute as @e[tag=cclashSlightningNew] at @s run function datapack:cclash/levelbelow	
tag @e[tag=cclashSlightningNew] remove cclashSlightningNew

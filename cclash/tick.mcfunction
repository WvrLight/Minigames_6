execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashSingvus:1}}}] at @s if score @s cclashCasted matches 3 run tellraw @s ["",{"text":"Conjurist Orbs ","color":"aqua"},{"text":"queue is full. ","color":"red"},{"text":"Please cast ","color":"red"},{"text":"Conjure or Clear Queue","color":"aqua"},{"text":" to clear queue.","color":"red"}]
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashDouzol:1}}}] at @s if score @s cclashCasted matches 3 run tellraw @s ["",{"text":"Conjurist Orbs ","color":"aqua"},{"text":"queue is full. ","color":"red"},{"text":"Please cast ","color":"red"},{"text":"Conjure or Clear Queue","color":"aqua"},{"text":" to clear queue.","color":"red"}]
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashTrixios:1}}}] at @s if score @s cclashCasted matches 3 run tellraw @s ["",{"text":"Conjurist Orbs ","color":"aqua"},{"text":"queue is full. ","color":"red"},{"text":"Please cast ","color":"red"},{"text":"Conjure or Clear Queue","color":"aqua"},{"text":" to clear queue.","color":"red"}]

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashSingvus:1}}}] at @s if score @s cclashCasted matches 3 run playsound minecraft:entity.player.attack.strong master @s ~ ~ ~ 100 0
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashDouzol:1}}}] at @s if score @s cclashCasted matches 3 run playsound minecraft:entity.player.attack.strong master @s ~ ~ ~ 100 0
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashTrixios:1}}}] at @s if score @s cclashCasted matches 3 run playsound minecraft:entity.player.attack.strong master @s ~ ~ ~ 100 0


execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashSingvus:1}}}] at @s if score @s cclashCasted matches 0..2 run function datapack:cclash/singvus
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashDouzol:1}}}] at @s if score @s cclashCasted matches 0..2 run function datapack:cclash/douzol
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashTrixios:1}}}] at @s if score @s cclashCasted matches 0..2 run function datapack:cclash/trixios

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashConjure:1}}}] at @s if score @s cclashCooldown matches 1.. run tellraw @s ["",{"text":"Conjure ","color":"aqua"},{"text":"still on cooldown. ","color":"red"}]
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashConjure:1}}}] at @s if score @s cclashCooldown matches 1.. run playsound minecraft:entity.player.attack.strong master @s ~ ~ ~ 100 0

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashConjure:1}}}] at @s if score @s cclashCspells matches 3 if score @s cclashCooldown matches 0 run tellraw @s ["",{"text":"Conjure ","color":"aqua"},{"text":"can not be casted as you can only have a maximum of 3 spells. ","color":"red"}]
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashConjure:1}}}] at @s if score @s cclashCspells matches 3 if score @s cclashCooldown matches 0 run playsound minecraft:entity.player.attack.strong master @s ~ ~ ~ 100 0

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashConjure:1}}}] at @s if score @s cclashCspells matches 0..2 if score @s cclashCooldown matches 0 run function datapack:cclash/conjure

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashClear:1}}}] at @s run function datapack:cclash/clear

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashMearth:1}}}] at @s run function datapack:cclash/mearth
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashFball:1}}}] at @s run function datapack:cclash/fball
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashPball:1}}}] at @s run function datapack:cclash/pball

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashRboulder:1}}}] at @s run function datapack:cclash/rboulder
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashFlight:1}}}] at @s run function datapack:cclash/flight
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashFflash:1}}}] at @s run function datapack:cclash/fflash

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashExhil:1}}}] at @s run function datapack:cclash/exhil
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashSonic:1}}}] at @s run function datapack:cclash/sonic
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashAearth:1}}}] at @s run function datapack:cclash/aearth

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashEarthquake:1}}}] at @s run function datapack:cclash/earthquake
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashFbeam:1}}}] at @s run function datapack:cclash/fbeam
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashSlightning:1}}}] at @s run function datapack:cclash/slightning

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashIspikes:1}}}] at @s run function datapack:cclash/ispikes
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashGmend:1}}}] at @s run function datapack:cclash/gmend
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashMeteor:1}}}] at @s run function datapack:cclash/meteor

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashSearth:1}}}] at @s run function datapack:cclash/searth
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashPice:1}}}] at @s run function datapack:cclash/pice
execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashMfloor:1}}}] at @s run function datapack:cclash/mfloor

execute as @a[scores={skill=1},nbt={SelectedItem:{tag:{cclashAerruption:1}}}] at @s run function datapack:cclash/aerruption


execute if score Players_Remaining: cclashMain matches 2.. run function datapack:cclash/actionbar
...
execute as @a[scores={cclashRboutime=1..29}] at @s run function datapack:cclash/levelbelow
...
#execute as @a[scores={cclashRboutime=1..29}] at @s run function datapack:cclash/levelabove
...
execute as @e[tag=cclashFbeam,scores={cclashDummy=120}] at @s run function datapack:cclash/fbeamline
...
execute as @e[tag=cclashIspikes,scores={cclashDummy=40}] at @s as @a[tag=cclashPlaying,distance=..2,gamemode=adventure] at @s run scoreboard players set @e[sort=nearest,limit=1,tag=cclashISthrowNew] cclashDummy 12
...
execute as @e[tag=cclashSearth,scores={cclashDummy=-90..-1}] at @s run effect give @a[tag=cclashPlaying,distance=..3,nbt=!{ActiveEffects:[{Id:19b}]}] poison 2 1 true
...
#Prison of Ice
execute as @e[tag=cclashPice,scores={cclashDummy=101..}] at @s if block ~ ~ ~ air run tp @s ^ ^ ^0.5
...
execute as @a[tag=cclashPlaying,scores={cclashAerruption=1}] at @s run function datapack:cclash/aerrupt
...
execute if score time cclashDummy matches 1 run function datapack:cclash/match
execute as @a[tag=cclashPlaying,scores={cclashDeath=1..}] at @s run function datapack:cclash/death
execute as @a[tag=cclashPlaying,scores={cclashDead=1}] at @s run function datapack:cclash/respawn
execute as @a[scores={ConjurerClash=1..}] at @s run function datapack:cclash/host
execute as @a[tag=cclashPlaying,scores={cclashMain=0}] at @s run function datapack:cclash/eliminated
execute if score Players_Remaining: cclashMain matches 1 run function datapack:cclash/victory
...
scoreboard players set @a[tag=cclashPlaying] skill 0
scoreboard players set @a[scores={cclashCspells=..-1}] cclashCspells 0

execute if score GameOn cclashDummy matches 1 run schedule function datapack:cclash/tick 1t
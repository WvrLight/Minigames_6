...
#Bomb plant
execute if score bombPlanted psDummy matches 1 as @e[tag=psBomb] run function datapack:pixelstrike/psabombplant
...
#execute as @a[scores={psBomb=1..,psSneak=0}] run scoreboard players set @s psBombTemp 0

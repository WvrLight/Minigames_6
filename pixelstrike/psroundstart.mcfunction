...
scoreboard players set psBuyTime psDummy 21
scoreboard players set psBuyDummy psDummy 11

#Start buy UI
function datapack:pixelstrike/psabuyui
...
execute as @r[team=psT] run function datapack:pixelstrike/givebomb

#Buy Menu
execute as @a[tag=psPlaying] run function datapack:pixelstrike/buymenu

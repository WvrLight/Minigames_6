...
execute anchored eyes positioned ^-0.4 ^-0.3 ^ run summon minecraft:arrow ~ ~ ~ {crit:1,damage:0.2d,life:1199s,Color:-1,Tags:["proj","Ammo"],Silent:1}
...
execute anchored eyes run particle minecraft:witch ^-0.4 ^ ^0.7 0 0.01 0 0 10 normal

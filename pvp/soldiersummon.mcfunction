...
scoreboard players add @s cd1 140
summon armor_stand ~ ~1 ~ {ShowArms:1b,NoBasePlate:1b,DisabledSlots:16128,Invulnerable:1b,Tags:["new"],HandItems:[{id:"minecraft:iron_sword",Count:1b},{}],ArmorItems:[{id:"minecraft:golden_boots",Count:1b},{id:"minecraft:golden_leggings",Count:1b},{id:"minecraft:golden_chestplate",Count:1b},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:"427aa647-eb1f-4e5e-8f14-291fec403b32",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMmFiYmUzZGZjY2ViYWIyNDk1OTk0ZGY4MzVhYmZiMjk2YmUwNDE4ZDJmNjIyODUwYmRlMTRjOWU4MjQyMmYxYyJ9fX0="}]}}}}],CustomName:"{\"text\":\"Soldier\"}"}
...
execute if entity @s[scores={summoncharge=1}] run give @s minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Summon Soldier (1 charge)\",\"color\":\"gold\",\"bold\":true}",},Unbreakable:1,Enchantments:[{id:"minecraft:power",lvl:1}],soldier:1,HideFlags:5} 1
...
replaceitem entity @s hotbar.8 minecraft:red_stained_glass_pane{display:{Name:"{\"text\":\"Ability on Cooldown\",\"color\":\"red\",\"bold\":true}",Lore:["{\"text\":\"This ability is on cooldown\",\"color\":\"gray\",\"italic\":true}"]},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:1s}]} 7
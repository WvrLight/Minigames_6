...
tag @s add vblaster1
item replace entity @s hotbar.0 with minecraft:crossbow{display:{Name:'{"text":"V-Blaster","color":"blue","bold":true}',Lore:['{"text":"Semi-automatic blaster pistol","color":"gray","italic":true}','{"text":" "}','[{"text":"Status:","color":"blue"},{"text":" Overheating!!!","color":"dark_purple","bold":true}]']},HideFlags:36,Damage:324,CustomModelData:1,vblaster1:1}

...
item replace entity @a[tag=vblasterc4] hotbar.0 minecraft:crossbow{display:{Name:'{"text":"V-Blaster","color":"blue","bold":true}',Lore:['{"text":"Semi-automatic blaster pistol","color":"gray","italic":true}','{"text":" "}','[{"text":"Status:","color":"blue"},{"text":" Warm","color":"yellow","bold":true}]']},HideFlags:36,Damage:81,CustomModelData:1,vblaster4:1} 1
tag @a[tag=vblasterc4] add vblasterc5
tag @a[tag=vblasterc4] remove vblasterc4

item replace entity @a[tag=vblasterc3] hotbar.0 minecraft:crossbow{display:{Name:'{"text":"V-Blaster","color":"blue","bold":true}',Lore:['{"text":"Semi-automatic blaster pistol","color":"gray","italic":true}','{"text":" "}','[{"text":"Status:","color":"blue"},{"text":" Hot","color":"red","bold":true}]']},HideFlags:36,Damage:162,CustomModelData:1,vblaster3:1} 1
tag @a[tag=vblasterc3] add vblasterc4
tag @a[tag=vblasterc3] remove vblasterc3

item replace entity @a[tag=vblasterc2] hotbar.0 minecraft:crossbow{display:{Name:'{"text":"V-Blaster","color":"blue","bold":true}',Lore:['{"text":"Semi-automatic blaster pistol","color":"gray","italic":true}','{"text":" "}','[{"text":"Status:","color":"blue"},{"text":" Very Hot","color":"dark_red","bold":true}]']},HideFlags:36,Damage:243,CustomModelData:1,vblaster2:1} 1

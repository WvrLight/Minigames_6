...
execute as @a[scores={cd2=322},tag=hydro] at @s run item replace entity @s hotbar.2 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Whirlpool Grenade (1 charge)\",\"color\":\"gold\",\"bold\":true}",},Unbreakable:1,CustomModelData:20,Enchantments:[{id:"minecraft:power",lvl:1}],wnade:1,HideFlags:5} 1
execute as @a[scores={cd2=322},tag=hydro] run item replace entity @s hotbar.3 minecraft:orange_stained_glass_pane{display:{Name:"{\"text\":\"Ability on Cooldown\",\"color\":\"red\",\"bold\":true}",Lore:["{\"text\":\"This ability is on cooldown\",\"color\":\"gray\",\"italic\":true}"]},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:1s}]} 8
execute as @a[scores={cd2=322},tag=hydro] run scoreboard players remove @s wnadedummy 1

execute as @a[scores={cd2=162},tag=hydro] at @s run item replace entity @s hotbar.2 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Whirlpool Grenade (2 charges)\",\"color\":\"gold\",\"bold\":true}",},Unbreakable:1,CustomModelData:20,Enchantments:[{id:"minecraft:power",lvl:1}],wnade:1,HideFlags:5} 1
execute as @a[scores={cd2=162},tag=hydro] run item replace entity @s hotbar.3 minecraft:orange_stained_glass_pane{display:{Name:"{\"text\":\"Ability on Cooldown\",\"color\":\"red\",\"bold\":true}",Lore:["{\"text\":\"This ability is on cooldown\",\"color\":\"gray\",\"italic\":true}"]},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:1s}]} 8
execute as @a[scores={cd2=162},tag=hydro] run scoreboard players remove @s wnadedummy 1

execute as @a[scores={cd2=1},tag=hydro] at @s run item replace entity @s hotbar.2 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Whirlpool Grenade (3 charges)\",\"color\":\"gold\",\"bold\":true}",},Unbreakable:1,CustomModelData:20,Enchantments:[{id:"minecraft:power",lvl:1}],wnade:1,HideFlags:5} 1
execute as @a[scores={cd2=1},tag=hydro] run item replace entity @s hotbar.3 minecraft:orange_stained_glass_pane{display:{Name:"{\"text\":\"Ability on Cooldown\",\"color\":\"red\",\"bold\":true}",Lore:["{\"text\":\"This ability is on cooldown\",\"color\":\"gray\",\"italic\":true}"]},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:1s}]} 8

...
execute if entity @s[scores={wnadedummy=1}] run replaceitem entity @s hotbar.2 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Whirlpool Grenade (2 charges)\",\"color\":\"gold\",\"bold\":true}",},Unbreakable:1,Enchantments:[{id:"minecraft:power",lvl:1}],wnade:1,HideFlags:5,CustomModelData:20} 1
execute if entity @s[scores={wnadedummy=2}] run replaceitem entity @s hotbar.2 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Whirlpool Grenade (1 charge)\",\"color\":\"gold\",\"bold\":true}",},Unbreakable:1,Enchantments:[{id:"minecraft:power",lvl:1}],wnade:1,HideFlags:5,CustomModelData:20} 1

replaceitem entity @s hotbar.3 minecraft:orange_stained_glass_pane{display:{Name:"{\"text\":\"Ability on Cooldown\",\"color\":\"red\",\"bold\":true}",Lore:["{\"text\":\"This ability is on cooldown\",\"color\":\"gray\",\"italic\":true}"]},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:1s}]} 8
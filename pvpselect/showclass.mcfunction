...
replaceitem entity @e[tag=classdummy] armor.head air
replaceitem entity @e[tag=classdummy] armor.chest air
replaceitem entity @e[tag=classdummy] armor.legs air
replaceitem entity @e[tag=classdummy] armor.feet air
replaceitem entity @e[tag=classdummy] weapon.mainhand air
replaceitem entity @e[tag=classdummy] weapon.offhand air
